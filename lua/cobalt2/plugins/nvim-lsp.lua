...
-- diagnostics
Group.new("DiagnosticError", colors.yellow:light(), nil, nil)
Group.new("DiagnosticHint", colors.light_pink, nil, nil)
Group.new("DiagnosticInfo", colors.light_blue, nil, nil)
Group.new("DiagnosticUnderlineError", colors.yellow:light(), nil, styles.underline)
...
Group.new("LspDiagnosticsDefaultError", colors.yellow:light(), nil, nil)
...
Group.new("LspDiagnosticsError", colors.yellow:light(), nil, nil)
Group.new("LspDiagnosticsErrorUnderline", colors.yellow:light(), nil, styles.underline)
...
Group.new("LspDiagnosticsVirtualTextError", colors.yellow:light(), nil, nil)
